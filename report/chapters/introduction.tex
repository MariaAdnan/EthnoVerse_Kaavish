...
\begin{itemize}
    ...
    \item Functional Web Platform Prototype
...
\begin{itemize}
    ...
    \item Integrated Virtual Tour Interface
...
\begin{itemize}
  \item \textbf{Risk:} Implementing Gaussian Splatting from scratch is technically demanding and GPU-intensive.
